...
Your program should:
1. Ask the user whst they learned today.
2. Add the entry to a file called 'learning_journal.txt'
3. Each entry should include the date and the time it was written.
...
print(f"\n your journal entry has been saved to 'learning_journal'")
